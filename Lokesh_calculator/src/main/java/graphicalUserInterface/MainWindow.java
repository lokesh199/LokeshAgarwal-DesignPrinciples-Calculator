...
import workingBackend.Addition;
import workingBackend.Calculator;
import workingBackend.Division;
import workingBackend.Multiplication;
import workingBackend.Subtraction;
...
public class MainWindow extends JFrame {
	...
	public MainWindow()
	{
		...
		final CustomTextField cf1=new CustomTextField(10,20,200,60,"12");
		final CustomTextField cf2=new CustomTextField(10,80,200,60,"2");
		final CustomTextField cf3=new CustomTextField(10,140,200,60,"");
		this.add(cf1);
		this.add(cf2);
		this.add(cf3);
		int n=4;
